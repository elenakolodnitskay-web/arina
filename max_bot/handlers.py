...
# посмотреть рекомендованный в приветствии. Распознавание текста с фото/PDF
# (Фаза 30) на MAX тоже не подключено — вебхук (max_bot/webhook.py) обрабатывает
# только message_created с текстом, вложения не парсятся вовсе.
# См. Plan.md.
