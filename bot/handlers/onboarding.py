...
HELP_TEXT = (
    ...
    "свободно, в любую сторону, без оплаты. На более полном тарифе умею "
    "подключать виртуальный офис — специализированных нейросотрудников (юрист, "
    "бухгалтер, делопроизводитель, HR, логист, продюсер соцсетей, копирайтер) — "
    "и управлять ими сама.\n\n"
